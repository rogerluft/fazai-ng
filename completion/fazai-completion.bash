...
_fazai_completion() {
    ...
    commands="qdrant vector ask import alias cloudflare cf github index sync config search inference agent ingest dashboard samba completion cleaner skill-seeker"
    ...
    case "${COMP_WORDS[1]}" in
        ...
        completion)
            ...
            ;;
        cleaner)
            local subcmds="--exec --dry-run --help"
            COMPREPLY=( $(compgen -W "${subcmds}" -- ${cur}) )
            return 0
            ;;
