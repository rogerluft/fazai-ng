...
import SSLConfigPanel from './SSLConfigPanel';
...
function CloudflarePage() {
  ...
  const tabs = [
    { id: 'zones' as Tab, label: 'Zones', icon: '[Z]' },
    { id: 'dns' as Tab, label: 'DNS', icon: '[D]', disabled: !selectedZoneId },
    { id: 'firewall' as Tab, label: 'Firewall', icon: '[F]', disabled: !selectedZoneId },
    { id: 'ssl' as Tab, label: 'SSL/TLS', icon: '[S]', disabled: !selectedZoneId },
    { id: 'cache' as Tab, label: 'Cache', icon: '[C]', disabled: !selectedZoneId },
    { id: 'analytics' as Tab, label: 'Analytics', icon: '[A]', disabled: !selectedZoneId },
  ];
